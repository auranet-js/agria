# Treść — #315 Węglanowe bez magnezu, odmiana 04 (pilot T-136, zaakceptowane `[J 11.09]`)

> 11.09.2026 · research: [`weglanowe-odmiana-04-research.md`](weglanowe-odmiana-04-research.md) · baza: [`../weglanowe-odmiana-04.md`](../weglanowe-odmiana-04.md)
> Źródła treści: **[K]** karta AGRII PDF (`/wp-content/uploads/2026/06/agria-karta-produktu-weglanowe-odmiana-04.pdf`) · karty PDF #318, #314, #306 do porównania ·
...
**Frazy karty:** `wapno węglanowe` 1 000 (szczyt VIII 2 400; do rewizji w D1) · `wapno odmiana 04` 30 · `wapno węglanowe odmiana 04` 10 ·
`wapno nawozowe odmiana 04` 10 · `wapno węglanowe bez magnezu` 10 · `wapno węglanowe sypkie` 20 · `wapno węglanowe cena` 70 ·
`wapno węglanowe cena za tonę` 90 · `wapno węglanowe luzem` <10 · `wapno bukowa` 50 · `wapno celiny` 10.
Poza kartą: frazy dawkowe (hub), `wapno nawozowe węglanowe` (D1), `lhoist bukowa` / `kopalnia celiny` (nawigacyjne).

**Hipoteza:** po zmianie #315 podniesie CTR na `wapno węglanowe` z 0,16% (1 klik. / 630 wyśw., 28 dni do 07.09) do co najmniej 1%
...
| pole | dziś | nowe |
|---|---|---|
| title (54 zn.) | Wapno węglanowe bez magnezu (min. 50% CaO) \| AGRIA | **Wapno węglanowe odmiana 04 bez magnezu, sypkie \| AGRIA** |
| meta description (155 zn.) | …Poprawia strukturę gleby i wspiera plony… | **Sypkie wapno węglanowe odmiana 04: min. 50% CaO, 0–2 mm, do gleb lekkich. Lhoist i Celiny, cztery magazyny, luz, big-bag, worek 25 kg. Od 57 zł/t netto.** |
| focus keyword | wapno weglanowe bez magnezu | **wapno węglanowe** |

## 3. Lead (`post_excerpt`)

> Wapno nawozowe węglanowe bez magnezu, odmiana 04 — sypkie, min. 50% CaO, frakcja 0–2 mm. Do odkwaszania gleb lekkich i piaszczystych:
> działa łagodnie i długo, 3–6 miesięcy, i nie wypala próchnicy. Produkują je Lhoist i kopalnia Celiny, a wysyłamy z czterech magazynów —
> Bukowa, Celiny, Górażdże, Tarnów Opolski — luzem, w big-bagach 1000 kg i w workach 25 kg.
>
> **Cena: od 57 zł/t netto luzem, przy dostawie całosamochodowej — za towar, bez transportu.**

## 4. Treść (`post_content`)

### H2 Wapno węglanowe odmiana 04 — sypkie, bez magnezu, do gleb lekkich

Odmiana 04 to klasyk wapna węglanowego — standard, który hurtownie i większe gospodarstwa zamawiają cyklicznie od lat. Zawiera min. 50% CaO,
...
- **Czas działania** — długotrwały: 3–6 miesięcy stabilnej korekty pH bez ryzyka wypalenia.
- **Dodatkowo** — gospodarstwa ekologiczne, sady, uprawy wieloletnie.
...
|---|---|---|---|---|
| Zawartość | min. 50% CaO | min. 41% CaO + min. 8% MgO | min. 50% CaO | min. 50% CaO |
| Forma, frakcja | sypkie, 0–2 mm | sypka, 0–2 mm | granulat, 3–6 mm | sypkie, frakcja zmienna |
| Dawkowanie | 1,5–6 t/ha | 1,5–6 t/ha | 1–6 t/ha | 3–6 t/ha |
| Czas działania | 3–6 miesięcy | 3–6 miesięcy | 3–6 miesięcy | 1–3 miesiące |
| Producent | Lhoist, Celiny | Kopalnia Jażwica | Grankal, Lhoist, Celiny | Kopalnia Drugnia |
...
| Parametr | Wartość |
|---|---|
| Zawartość CaO | min. 50% CaO |
| Reaktywność | ~70–90% |
| Typ reakcji | Długodziałająca (bezpieczna) |
| Forma fizyczna | Sypkie |
| Frakcja | 0–2 mm |
| Zastosowanie | Odkwaszanie gleb lekkich i piaszczystych |
| Efekt zastosowania | Wzrost pH, poprawa struktury, uzupełnienie wapnia pokarmowego |
| Dawkowanie | 1,5–6 t/ha |
| Szybkość działania | Długotrwałe (3–6 miesięcy) |
| Dodatkowe zastosowanie | Gospodarstwa eko, sady, uprawy wieloletnie |
| Segment | Rolnictwo, sadownictwo, hurtownie |
| **Forma dostawy** | **Big-bag 1000 kg, worek 25 kg, luz 25 - 27 t** |
| Magazyn | Bukowa (29-105), Celiny (26-020), Górażdże (47-316), Tarnów Opolski (46-050) |
| Producent | Lhoist, Celiny (Hochel Group) |
| Dostępność | Cały rok |
...
Dowozimy własnym transportem, samochodami od 3 do 24 t, z najbliższego z czterech magazynów. Koszt dostawy pod Twój adres podamy w wycenie.

### H2 Najczęściej zadawane pytania

**H3 Co to jest wapno węglanowe odmiana 04?**
...
**H3 Po jakim czasie działa wapno węglanowe?**
Odmiana 04 działa długotrwale — daje 3–6 miesięcy stabilnej korekty pH, bez ryzyka wypalenia.

**H3 Wapno węglanowe bez magnezu czy z magnezem?**
...
z najbliższego z czterech magazynów; napisz, ile ton potrzebujesz i dokąd, a podamy cenę z dostawą.

**H3 Czy mogę zamówić mniej niż cały samochód?**
Tak. Odmiana 04 jest też w big-bagach 1000 kg i w workach 25 kg. Napisz, ile potrzebujesz — dobierzemy formę dostawy i samochód,
wozimy samochodami od 3 do 24 t.

### H2 Zapytaj o ofertę, zamów próbkę — *bez zmian*

**H3 Poradniki techniczne** — *bez zmian*
...
2. ~~„Bukowa (29-109)" w tabeli~~ — **rozstrzygnięte `[J 11.09]`: poprawiamy na stronie na „Bukowa (29-105)"** (kod z karty #307 PDF i adresu Lhoist Bukowa).
3. **Cena w meta description (`Od 57 zł/t netto`) zostaje** `[J 11.09]` — warunek: przy każdej zmianie ceny aktualizujemy też meta (reguła zapisana w `FAKTY_KLIENTA` §7).
4. **Focus keyword `wapno węglanowe`** — karta i tak zbiera tę frazę (801 wyśw. w 90 dniach). Jeśli w D1 powstanie kategoria węglanowa, fraza przejdzie tam.

## 7. Co znika w stosunku do dzisiejszej karty

FAQ z frakcjami 0–0,09 / 0–0,2 / 0–5 mm · plony +15–30% · „szybko, ale łagodnie, koryguje odczyn” · „zwiększając pojemność wodną i powietrzną” ·
„Zastosowanie funkcjonalne” z dopiskiem → „Zastosowanie” jak w karcie · „Efekt: Wzrost pH” → pełny efekt z karty · Bukowa 29-105 i „Góraźdzce”, „Hochcel” → 1:1 z karty ·
sekcja „Skuteczne odkwaszanie: zdrowsze uprawy, wyższe zyski” · zdanie o cenie „przy dostawie całosamochodowej 24 t” → bez tonażu.
