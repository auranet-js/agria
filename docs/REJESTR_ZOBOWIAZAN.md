...
| **T-049** | OLX — **warstwa zdjęć przed emisją** `[J 20.08]` | OLX | P | Treści zaakceptowane 20.08, publikacja czeka na Premium (T-041), więc zdjęcia są jedyną robotą po naszej stronie. **Stan zmierzony 20.08:** 200 ogłoszeń, 27 unikalnych zdjęć, wszystkie HTTP 200; 5–7 zdjęć na ogłoszenie. **Słaby punkt: plansze Auranetu mają 435×700 px** — konkurencja wystawia kadry 3000×4000. Kreda pastewna bez własnej planszy. **Analiza wykonana 20.08 — czeka na trzy decyzje Janka.** Konkurencja zmierzona na własnej próbce 1 105 ogłoszeń z publicznego API (`scripts/olx/market_photos.py` → `data/olx/market/2026-08-20-zdjecia.json`): mediana 4 zdjęcia/ogłoszenie (liderzy wolumenu 8 = limit), mediana szerokości 1. zdjęcia **1 008 px** wobec naszych 435, kadry ≥4 000 px to **6 %** ogłoszeń, nie norma. Próbka losowa 40 pierwszych zdjęć: **36/40 realne zdjęcie z podwórka**, 4/40 grafika — my otwieramy 200/200 grafiką. **Cztery wady niezależne od rozdzielczości:** trzy kadry z CDN są **wygenerowane AI i mają podrobione etykiety producenta** (worki 52 ogł., big-bagi 188 ogł.); big-bagi z napisem „Agrobielik" lecą na ogłoszeniach kredy i węglanowego (136 ogł.); kreda nawozowa granulowana ilustrowana wapnem węglanowym (14 ogł., błędny `_thumbnail_id` na ID 305 — wada produkcji); kreda pastewna bez własnej planszy (12 ogł.). **Zysk darmowy: plansze odzyskane w 750×1205** (CDN trzyma źródła 1500×1205, nie 871×700) — przecięte, czekają na „ok". **Wymogi OLX zweryfikowane empirycznie na pilocie 1089946612:** `photos_limit` 8, OLX **zaciąga plik z URL-a raz przy publikacji i hostuje u siebie** (nasze URL-e muszą żyć tylko w chwili wysyłki), **nie zmniejsza** (2048×2048 przechowane), WEBP przyjęty i przekonwertowany na JPEG mimo że pomoc wymienia tylko jpg/png. Zestaw dowodowy: `https://auratest.pl/fe4f58fec53ctmp/agria-olx-zdjecia-analiza-2026-08-20.html`. Prompt do wątku: `docs/prompty/2026-08-20-PROMPT_T-041_ZDJECIA.md` |
