...
| **T-051** | **Miniatury OLX nieczytelne na liście mobilnej — decyzja o formacie** | OLX | P | **Zmierzone 21.08** (emulacja iPhone 390×844, mobilny UA, realny OLX): kadr miniatury na liście mobilnej to **150×183 px, proporcja 0,82** przy `object-fit: cover`, a nasze pliki mają 1500×1050 (proporcja 1,43) — **widać środkowe 57% szerokości**, ginie po 21,5% z każdej strony. Na wszystkich 12 wzorach ucięte: pierwsza i ostatnia sylaba hasła, początek paska korzyści, sygnet Agria. **Karta ogłoszenia jest bez strat** — problem dotyczy wyłącznie miejsca, w którym zapada decyzja o kliknięciu. Dowody: `auratest.pl/fe4f58fec53ctmp/agria-olx-miniatury-2026-08-21.html`. Narzędzie: `scripts/olx/zrzut_mobile.mjs` (Puppeteer; Chrome MCP nie emuluje telefonu). **Czeka na decyzję Janka między trzema wariantami** (pionowa 4:5 jako slot 0 — rekomendacja / przeprojektowanie layoutu w bezpieczny środek / miniatura bez tekstu). Przed masową podmianą sprawdzić na JEDNYM ogłoszeniu, czy `PUT` ze zmienionymi zdjęciami wraca do moderacji i czy zużywa miejsce z pakietu (`left: 0`). Okno czasowe: pakiet wygasa 16.09. Prompt: `docs/prompty/2026-08-21-PROMPT_T-051_MINIATURY_OLX.md` |
...
**Stan na 20.08 wieczorem: z trzynastu pozycji „teraz" zamkniętych jest dziewięć** (T-048, T-008, T-009,
T-011, główna część T-010 — 15 kart z ceną — T-042, T-049, T-046 i T-041). W kolejce zostają trzy, w tym T-027
czekające wyłącznie na werdykt Google. **Kanał OLX ruszył 20.08** — 200 ogłoszeń w emisji do 19.09; pakiet wygasa
