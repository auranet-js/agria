...
| **T-055** | Blok C — klaster „pole": terminarz (przebudowa `/jak-stosowac-wapno-nawozowe/`), hub `/jakie-wapno-na-pole/`, trzy spoke'y uprawowe | SEO | R | **Architektura rozstrzygnięta ADR-em `2026-08-21-architektura-pole-hub-i-spoke.md`** po uwadze Janka, że jeden poradnik „jakie wapno na pole" wyczerpałby frazę i zablokował uprawy. Trzy poziomy na rozłącznych frazach: terminarz (oś KIEDY, ~1 110/mies.), hub (oś JAKIE — rodzaj wapna × typ gleby, ~980), spoke'y: łąki 210, zboża ozime 190 (z rzepakiem jako sekcją), ziemniaki 170. **Próg URL-a: ≥3 frazy i ≥100/mies., liczone z GSC.** Hub nie dostaje H2 z nazwą uprawy. Pozostałe uprawy pokryte **tabelą uprawową w hubie + selektorem uprawy w kalkulatorze + FAQ per gatunek**, nie osobnymi adresami. ⚠️ **Blokada tabeli:** optymalny odczyn i dawka per gatunek muszą pochodzić z IUNG-PIB albo weryfikacji Kazimierza, nie z rozumowania. Terminy: terminarz 22.08, ozime 05.09, hub 10.09, łąki 15.09, ziemniaki 20.09 |
...
| **T-058** | Ads — pozostałe: grupa „Producent”, rewizja grupy „Wapno magnezowe i kreda”, ocena po 7 dniach | Ads | P | **Rdzeń wykonany 21.08** (dowód w dzienniku): trzy kampanie, przesunięcie budżetu, kampania Paszarstwo, wykluczenia, stawka Brand, sobota na rozszerzeniu połączeń. **Zostaje:** (1) grupa „Producent” — `wapno nordkalk` 210/mies. HIGH, `nordkalk` 880; licytacja na cudzy znak jest dozwolona zawsze, ale **nazwy nie użyjemy w treści reklamy**, dopóki T-040 nie potwierdzi statusu dystrybutora, więc teksty trzeba napisać bez niej; (2) grupa „Wapno magnezowe i kreda” stoi na stawce **1,00 zł przy suficie aukcji ~2,00** — przez 7 dni 38 wyświetleń i 1 kliknięcie, czyli praktycznie nie działa; do rozstrzygnięcia, czy podnieść, czy wygasić i oddać budżet; (3) **ocena efektu naprawionej ścieżki kontaktu — nie wcześniej niż po 7 dniach**, czyli 28.08 (pierwszy odczyt `phone_impressions` i `phone_calls` po zmianie harmonogramu) |
...
| **T-060** | Magnez i fosfor jako kierunek treści `[J 21.08]` | Zgłoszone przez Janka 21.08 ze wskazaniem „temat na inny czas" — **zaparkowane świadomie, nie pominięte.** Magnez jest częściowo w toku (moduł Mg w kalkulatorze, T-043/T-044) i w ofercie (5 produktów z MgO). Fosfor to nie produkt AGRII, ale **odczyn gleby rządzi jego przyswajalnością** — przy pH poniżej 5,5 fosfor wiąże się z glinem i żelazem, więc wapnowanie jest warunkiem działania nawozów fosforowych. To argument sprzedażowy, którego nie używamy, i klaster treści, którego nie mierzyliśmy. Do rozstrzygnięcia: czy wchodzi jako rozszerzenie kalkulatora, czy jako osobny klaster treści po sezonie |
...
**Stan na 21.08: zamkniętych czternaście pozycji** — dziewięć z pierwotnej listy „teraz" (T-048, T-008, T-009,
