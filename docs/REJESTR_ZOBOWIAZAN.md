...
| **T-058** | Ads — przebudowa kampanii: struktura segmentowa, zaległe korekty z 18.08, rewizja wykluczeń | Ads | P | 14–20.08: **280,30 zł, 147 kliknięć, 0 konwersji.** 90% udziału w wyświetleniach tracone przez budżet, 2,7% przez ranking. Żadna z pięciu rekomendacji z `docs/sesje/2026-08-18-ads-dzien5-diagnoza.md` nie została wykonana — Brand nadal 0,50 zł, brak grupy „Producent”, brak 22 wykluczeń obcych marek. Do rewizji: `pastewna`/`kury`/`drób` na wykluczeniach odcina produkt o najwyższej marży (T-054) |
| **T-059** | Landingi Ads — ścieżka kontaktu: telefon w hero, pasek sticky na mobile, formularz „oddzwonimy”, cena nad zgięciem | Strona | R | **Zaproponowane 18.08 w pliku sesyjnym, nigdy nieprzeniesione do rejestru — stąd niewykonane.** Pomiar 21.08: pierwszy `tel:` na obu landingach to **ikonka słuchawki na 29–30% wysokości dokumentu**, numer jako czytelny tekst dopiero na **60%**, cena na **57%**. `phone_impressions` 14–20.08: **62 przy 1 023 wyświetleniach reklamy**. To jest warunek sensu T-058 — bez tego kolejne kliknięcia nie mają gdzie skonwertować |
...
**Stan na 21.08: zamkniętych dwanaście pozycji** — dziewięć z pierwotnej listy „teraz" (T-048, T-008, T-009,
T-011, główna część T-010 — 15 kart z ceną — T-042, T-049, T-046 i T-041) plus **T-051**, **T-052** i **T-053**,
zgłoszone i domknięte tego samego dnia. W kolejce zostaje dziewięć: T-026 i T-027 (czeka wyłącznie na werdykt
Google) oraz sześć nowych pozycji sezonowych i reklamowych **T-054…T-059**, rozpisanych 21.08 po audycie fraz. **Kanał OLX ruszył 20.08** — 200 ogłoszeń w emisji do 19.09; pakiet wygasa
