...
| **T-041** | **Publikacja 199 ogłoszeń OLX — akcept jest, do wykonania** | OLX | P | **Akcept Janka na uruchomienie 20.08.** Pakiet Premium 200 aktywny do 16.09, zużyte 1 z 200. Payload gotowy: 200 ogłoszeń, tytuły 123–141 zn., opisy 3 518–4 479 zn., 56 adresów zdjęć — wszystkie HTTP 200. `posted.json` ma jedną pozycję (pilot 1089946612, `active`), więc do wystawienia zostaje **199**. **Nie wypuszczać naraz** — moderację przeszedł dotąd jeden tytuł i jeden opis, a regulamin pkt 13.11 grozi zawieszeniem konta przy powtarzających się naruszeniach. Token OLX żyje 24 h i 20.08 padł w środku operacji. Prompt do wątku: `docs/prompty/2026-08-20-PROMPT_T-041_PUBLIKACJA.md` |
...
**Stan na 20.08 wieczorem: z trzynastu pozycji „teraz" zamkniętych jest osiem** (T-048, T-008, T-009,
T-011, główna część T-010 — 15 kart z ceną — T-042, T-049 i T-046). W kolejce zostają trzy, w tym T-027
czekające wyłącznie na werdykt Google. **T-041 odblokowany** — pakiet Premium 200 jest kupiony i aktywny do 16.09; publikacja planowana 21.08 po weryfikacji kompletu przez Pawła i Kazimierza. **T-006 i T-007 zdjęte z listy 20.08** (decyzja Janka /
