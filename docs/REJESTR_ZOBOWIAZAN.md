...
| **T-049** | OLX — **warstwa zdjęć przed emisją** `[J 20.08]` | OLX | P | Treści zaakceptowane 20.08, publikacja czeka na Premium (T-041), więc zdjęcia są jedyną robotą po naszej stronie. **Stan zmierzony 20.08:** 200 ogłoszeń, 27 unikalnych zdjęć, wszystkie HTTP 200; 5–7 zdjęć na ogłoszenie. **Słaby punkt: plansze Auranetu mają 435×700 px** — konkurencja wystawia kadry 3000×4000. Kreda pastewna bez własnej planszy. Snapshot rynku `data/olx/market/2026-08-07.json` nie ma zdjęć, ale publiczne API OLX zwraca `photos` z wymiarami (zweryfikowane 20.08) — analiza konkurencji wykonalna skryptem. Prompt do wątku: `docs/prompty/2026-08-20-PROMPT_T-041_ZDJECIA.md` |
